...
<html>
    ...
    <link rel="stylesheet" href="../../../css/thean_academy/register.css" />
        <script type="text/javascript">
            ...
            function nt(){
                ...
                var add= document.getElementById("idt").value;
              
               
                 
                var link='pwfindok.jsp?k=1&nm='+nm+'&ph='+ph+'&id='+add;
    ...
    <form method="post" name="smsForm" action="smssend.jsp">
        ...
        <div class = "iden-container">
            ...
            <div class = "iden">
                <div class = "iden-title">Id</div>
                <div class = "input-here"><input type="text" name="idt" id="idt"></div>
            </div>
            <div class = "iden">
