	...
	<aside
		...
		<div class="sidenav-header">
			<i
				...
				aria-hidden="true" id="iconSidenav"></i> <img
				src="./assets/img/logo-ct-dark.png" class="navbar-brand-img h-100"
				alt="main_logo"> <span class="ms-1 font-weight-bold">Argon
				Dashboard 2</span> </a>
		</div>
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link active"
					href="index.jsp">
						...
						</div> <span class="nav-link-text ms-1">대시보드</span>
				</a></li>
				<li class="nav-item"><a class="nav-link "
					href="./pages/tables.jsp">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
				...
				<li class="nav-item"><a class="nav-link "
					href="./pages/billing.html">
						...
						</div> <span class="nav-link-text ms-1">서버관리</span>
				</a></li>
				<li class="nav-item"><a class="nav-link "
					href="./pages/virtual-reality.html">
						...
						</div> <span class="nav-link-text ms-1">영상관리</span>
				</a></li>
				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm"><a
							class="opacity-5 text-white" href="javascript:;">더안건축</a></li>
					...
					<div class="card">
						<div class="card-body p-3">
							<div class="row">
								<div class="col-8">
									<div class="numbers">
										<p class="text-sm mb-0 text-uppercase font-weight-bold">수입</p>
										<h5 class="font-weight-bolder">//db연동해 수입계산</h5>
										<p class="mb-0"></p>
									</div>
								</div>
					...
					<div class="card">
						<div class="card-body p-3">
							<div class="row">
								<div class="col-8">
									<div class="numbers">
										<p class="text-sm mb-0 text-uppercase font-weight-bold">회원수</p>
										...
										<h5 class="font-weight-bolder">
											<%String sql = "select count(user_number) from USER;";
                        ...
                        try {	 
                            ...
                            if(rs.next()) {
                                %>
											<h2><%=rs.getString("count(user_number)") %>명
											</h2>
											<%   
					...
					<div class="card">
						<div class="card-body p-3">
							<div class="row">
								<div class="col-8">
									<div class="numbers">
										<p class="text-sm mb-0 text-uppercase font-weight-bold">오늘의
											조회수</p>
										<h5 class="font-weight-bolder">
											<%
                      Date now = new Date();
                  	...
                  	sql = "select count(server) from iplog where page='main.jpg' and data like'%"+today+"%';";
                       conn = Util.getConnection();     
                        ...
                        try {	 
                            ...
                            if(rs.next()) {
                                %>
											<h2><%=rs.getString("count(server)") %>회
											</h2>
											<%   
					...
					<div class="card">
						<div class="card-body p-3">
							<div class="row">
								<div class="col-8">
									<div class="numbers">
										<p class="text-sm mb-0 text-uppercase font-weight-bold">서버상태</p>
										<h5 class="font-weight-bolder">
											<%
           
                  
                  	sql = "select count(server) from iplog where server='경고' and data like'%"+today+"%';";
                       conn = Util.getConnection();     
                         res = null;
                        ...
                        try {	 
                            ...
                            if(rs.next()) {
                            	if( Integer.parseInt(rs.getString("count(server)"))<50){
                            		 %>
											<h2 style="color: green;">정상</h2>
											<%   
                            	}else{
                            		

                            		sql = "select count(server) from iplog where server='심각';";
                            		 PreparedStatement pas = Prepare.getPrepare(conn, sql);
                                     ResultSet ras = pas.executeQuery();
                                     
                                     if(ras.next()){
                                    	 
                                 			if( Integer.parseInt(ras.getString("count(server)"))>0){
                                 				
                                 				 %>
											<h2 style="color: red;">심각</h2>
											<%
							...
							<div class="carousel-inner border-radius-lg h-100">
								...
								<div class="carousel-item h-100"
									...
									<div
										...
										<h5 class="text-white mb-1">Faster way to create web
											pages</h5>
										<p>That’s my skill. I’m not really specifically talented
								...
								<div class="carousel-item h-100"
									...
									<div
										...
										<h5 class="text-white mb-1">Share with us your design
											tips!</h5>
										<p>Don’t be afraid to be wrong because you can’t learn
