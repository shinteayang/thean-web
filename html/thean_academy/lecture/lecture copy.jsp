...
<html lang="en">
    ...
    <body>
            ...
            <div id="body">
                <div class="menubar">
                    <div class="info-container">
                        <div class="title-container">
                            ...
                            <%
                                PreparedStatement pspr = conn.prepareStatement("SELECT COUNT(*) AS tot, SUM(CASE WHEN ys = 'y' THEN 1 ELSE 0 END) AS spe FROM videotime WHERE ctnum = ?");
                                pspr.setInt(1, id);
                ...
                <div class="video-container">
                    ...
                    <%
                        ...
                        PreparedStatement pstmtct = conn.prepareStatement("select * from videotime where ctnum = " + id + " and videonum = 1");
                            ...
                            %>
                                <div class="video">
                                    ...
                                    <div class="video-frame">
                                        <video id = "video-1" ontimeupdate="updateCurrentTime" onseeking="preventSeekForward" class = "lecture-video<%if (ys == "n") {%> video-disabled<%}%>" controls controlsList="nodownload" oncontextmenu='return false'>
                                    ...
                                    <script>
                                        ...
                                        let maxViewedTime = 0; // 가장 길게 본 시간

                                        function updateCurrentTime(event) {
                                            const current = event.target.currentTime;
                                            if (current > maxViewedTime) {
                                                maxViewedTime = current;
                                            }
                                        }

                                        function preventSeekForward(event) {
                                            const current = event.target.currentTime;
                                            const target = event.target.seeking ? event.target.seeking : current;
                                            if (target > current) {
                                                event.preventDefault(); // 시간 조절바 이동을 막음
                                                return false;
                                            }
                                            if (target < maxViewedTime) {
                                                event.target.currentTime = maxViewedTime;
                                                event.preventDefault(); // 시간 조절바 이동을 막음
                                                return false;
                                            }
                                        }
        ...
        <script>
            ...
            const title_id = document.getElementById("radio1");
