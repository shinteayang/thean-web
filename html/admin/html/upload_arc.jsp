...
<%
    ...
    out.println(uploadedFileNames);

    String name = multipartRequest.getParameter("name");
    String usage = multipartRequest.getParameter("usage");
    String loc = multipartRequest.getParameter("loc");
    String land = multipartRequest.getParameter("land");
    String total = multipartRequest.getParameter("total");
    ...
    PreparedStatement ps = conn.prepareStatement("insert into arc (nm, work, gps, ground, grow, design, photo, etc, phm, cat, year) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    PreparedStatement ps1 = conn.prepareStatement("select max(id) as max_id from arc");
    ...
    response.sendRedirect("arc.jsp?select=all&search=");
%>
