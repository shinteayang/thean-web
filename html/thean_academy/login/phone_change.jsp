...
<html>
    ...
    <link rel="stylesheet" href="../../../css/thean_academy/register.css" />
        <script type="text/javascript">
            ...
            function nt(){
                ...
                var link='../user/change_phone_ok.jsp?k=1&nm='+nm+'&ph='+ph;
                if(k==1){
                    alert("성공");
    ...
    <form method="post" name="smsForm" action="smssendch.jsp">
        ...
        <div class = "iden-container">
            ...
            <div class = "iden">
                <div class = "iden-title">변경할 휴대폰번호</div>
                <div class = "input-here"><input type="text" name="rphone" id="ph" > <button class = "sub-btn" type="submit">인증번호 전송</button> </div>
            </div>
           ...
           <form action="">
            ...
            <div class="btns">
                <button class = "btn1" type="button" onClick="nt()">변경하기</button>
