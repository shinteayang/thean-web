...
<head>
	...
	<script>
		...
		function register() {
			...
			const digit1 = $('#digit1').val().trim();
			const digit2 = $('#digit2').val().trim();
			const digit3 = $('#digit3').val().trim();
			...
			if (digit1.length == 0 | digit2.length == 0 | digit3.length == 0) { alert("휴대폰 번호를 입력해주세요."); return false; }
		...
		<div class = "iden-container">
			<form name="registerForm"  onsubmit = "return register()" id = "registerForm" action="isRegister.jsp" method="post">
				<div class = "iden">
					...
					<div class = "input-here"><input id = "id" type="text" name = "id" autocomplete="off"/><button type = "button" id = "idCheckBtn" onclick = "checkId()">중복확인</button>
					</div>
				</div>
				<div class = "iden">
				...
				<div class = "iden">
					<div class = "iden-title">생년월일</div>
					<div class = "input-here">
						<input type="date" name = "date"/>
						<input name = "birth" type="radio" value = "sun" />양력 
						<input name = "birth" type="radio" value = "moon" />음력
					</div>
				</div>
				<div class = "iden">
					<div class = "iden-title">성별</div>
					<div class = "input-here">
                ...
                <div class = "iden">
                    ...
                    <div class = "input-here">
                        ...
                        <button type = "button" onClick="goPopup();">주소입력</button>
                    </div>
                </div>
				<div class = "iden">
					<div class = "iden-title">직업</div>
					<div class = "input-here"><input type="text" name = "job" autocomplete="off"/></div>
				</div>
				<div class = "iden">
