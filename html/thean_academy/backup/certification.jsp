...
<html>
    ...
    <form method="post" name="smsForm" action="smssend.jsp">
        ...
        <input type="text" name="subject" value="제목"  style="display:none;">더안건축학원 인증번호
        <br /> 전송메세지
        <textarea name="msg" cols="30" rows="10" style="width:455px; display:none;">인증번호는 <%=randomNum %>입니다</textarea>
        <br />
        <br />
    <br />성명
        <input type="text" name="user" id="nm"> 

        <br />휴대폰번호
        <input type="text" name="rphone" id="ph" value=> 
        ...
        <br />인증번호
        <input type="text" name="us" id="uas">      
        <input type="button" value="인증하기" onClick="ck()">
        <a href="certification.jsp"><input type="button" value="인증정보초기화"></a> 
        <br />
        <input type="button" value="계속하기" onClick="nt()">
    </body>
    <APM_DO_NOT_TOUCH>
        <script type="text/javascript">
        (function(){   
