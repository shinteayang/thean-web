    ...
    <div id = "main">
        ...
        <div id = "body">
                    ...
                    <div class = "info">
                        ...
                        <div class = "order-info">
                            ...
                            <div class = "order-lecture">
                                <div class = "ct-title"><%=ct_name %>&nbsp;(<%=day %>일)</div>
                    ...
                    <div class = "info">
                        ...
                        <div class = "coupon-info">
                                <%
                                    if(cp>999) {
                                        %>
                                            <div class = "point-text">남은 포인트</div>
                                            <form method="post" action="buy.jsp" class="coupon">
                                            <input type="text" name="id" value="<%=id%>" hidden/>
                                            <input class = "coupon-input" type = "text" value="<%=dec.format(point-cp) %>" readonly>
                                            <input type="text" type = "text" name = "cd" hidden value = "<%=point-cp%>">
                                        ...
                                        %>
                                            ...
                                            <input type="text" name = "cp" hidden value="<%=point%>">
            ...
            <div class = "right">
                <div class = "pay-container">
                    <div class = "info">
                        ...
                        <div class = "pay-info">
                            ...
                            <hr class = "line">
                            <div class = "info-title">결제방법</div>
                            <div class = "howpay">
                                <div><label for="1">카드결제</label> <input type="radio" id = "1" name = "how" value = "" checked></div>
                ...
                <% 
                if(mprice==0) {
                	%><form method="get" name = "frm" class = "payment-btn">
                   <%  spw = spw+1606;  %>
...
<%  spw = spw+1606;  %>
  AUTHNICE.requestPay({
    ...
    mailUserid: '<%=id%>',
    a: 'az',
    returnUrl: 'https://thean-ac.com:8081/source/html/thean_academy/buy/buyok.jsp?id=<%=op_a%>&ct=<%=id%>&cp=<%=cp%>&spw=<%=spw%>', //API를 호출할 Endpoint 입력
